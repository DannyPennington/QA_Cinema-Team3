...
class MongoService @Inject()(
  ...
  def reInnit(): Future[WriteResult] = {
    currentCollection.map {
      _.drop
    }
    ...
    createFuture(FutureReleaseInfo("Star Wars: Episode 1", "Voldemort", List("Qui-Gon Jinn","Double Saber Dude", "Jar Jar"),"01/04/2020","https://m.media-amazon.com/images/M/MV5BYTRhNjcwNWQtMGJmMi00NmQyLWE2YzItODVmMTdjNWI0ZDA2XkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg"))
    createFuture(FutureReleaseInfo("Star Wars: Episode 2", "Gandalf", List("Boba Fett","Count Dooku"),"02/04/2020","https://m.media-amazon.com/images/M/MV5BMDAzM2M0Y2UtZjRmZi00MzVlLTg4MjEtOTE3NzU5ZDVlMTU5XkEyXkFqcGdeQXVyNDUyOTg3Njg@._V1_.jpg"))
    createFuture(FutureReleaseInfo("Star Wars: Episode 3", "Dumbledore", List("The Senate","Mace Windu", "Dewit"),"03/04/2020","https://images-na.ssl-images-amazon.com/images/I/71MKj4j-isL._SL1200_.jpg"))
    createFuture(FutureReleaseInfo("Star Wars: Episode 4", "Taylor Swift", List("Darth Vadar","Han Solo"),"04/04/2020","https://m.media-amazon.com/images/M/MV5BNzVlY2MwMjktM2E4OS00Y2Y3LWE3ZjctYzhkZGM3YzA1ZWM2XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg"))
    createFuture(FutureReleaseInfo("Star Wars: Episode 5", "Chad", List("Yoda","R2-D2", "C-3PO"),"05/04/2020","https://images-na.ssl-images-amazon.com/images/I/71tglII26nL._AC_SY679_.jpg"))
