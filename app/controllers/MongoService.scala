...
class MongoService @Inject()(
  ...
  def currentMoviesReInnit(): Future[WriteResult] = {
    ...
    createCurrentMovie(MovieInfo("Pocahontas","Romeo",List("D","E","F"),List(LocalDateTime.now().plusHours(1).toString(),"17"),"https://54disneyreviews.files.wordpress.com/2014/09/pocahontas-poster.jpg"))
